...
function EmployeeProfileScreen() {
  ...
  // Training the employee is actually on, pulled off each event's roster.
      ...
      <div className="flex-1 flex flex-col w-full relative min-h-[100dvh]">
        ...
        <main className="flex-1 p-6 lg:p-8 min-w-0">
          ...
          <div className="flex items-center justify-between gap-4">
            ...
            <button
              onClick={() => router.push("/branch-admin/hr/exit-clearance")}
          ...
          <div className="mt-5 grid grid-cols-1 lg:grid-cols-3 gap-5">
            ...
            <div className="flex flex-col gap-5 lg:col-span-2">
              ...
              <div className="overflow-hidden rounded-xl border border-[#EEF1F6] bg-white">
                <div className="flex items-center justify-between p-5">
                  ...
                  <button
                    onClick={() =>
                      router.push(`/branch-admin/hr/attendance?employeeId=${employeeId}`)
                    }
            ...
            <div className="flex flex-col gap-5 lg:col-span-1">
              ...
              {/* Leave */}
              <div className="rounded-xl border border-[#EEF1F6] bg-white p-5">
                <h2 className="text-[16px] font-bold text-[#111827]">Leave Requests</h2>
