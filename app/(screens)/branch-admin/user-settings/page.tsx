      ...
      <aside className="w-[245px] sm:w-[260px] bg-white border-r border-[#EEF1F6] flex-shrink-0 flex flex-col hidden lg:flex h-screen sticky top-0 left-0">
        ...
        <div className="mt-auto border-t border-[#EEF1F6] p-4 flex items-center gap-3 bg-[#FAFAFA]">
          <div className="w-[36px] h-[36px] rounded-full overflow-hidden border-2 border-white shadow-sm shrink-0">
            ...
            <div className="w-full h-full bg-[#1E293B] flex items-center justify-center text-white text-[12px] font-[700]">AM</div>
          </div>
          <div className="flex flex-col truncate">
            <span className="text-[#111827] text-[13.5px] font-[800] truncate">Alex Morgan</span>
            <span className="text-[#64748B] text-[11.5px] font-[500] truncate">Branch Officer</span>
          </div>
        </div>
      </aside>
            ...
            <div className="p-6 sm:p-8 border-b border-[#EEF1F6] bg-white flex flex-col sm:flex-row sm:items-center justify-between gap-6">
              ...
              <div className="flex items-center gap-5 sm:gap-6">
                ...
                <div className="w-[75px] sm:w-[85px] h-[75px] sm:h-[85px] rounded-full overflow-hidden flex items-center justify-center shrink-0 border-[3px] border-[#F1F5F9] shadow-sm">
                   ...
                   <div className="w-full h-full bg-[#B28A6D] flex flex-col justify-end items-center relative overflow-hidden">
                     <div className="w-[35px] h-[35px] bg-[#FFE0C2] rounded-full absolute top-[10px]"></div>
                     <div className="w-[60px] h-[40px] bg-[#1E293B] rounded-t-full absolute bottom-0 translate-y-1"></div>
                   </div>
                </div>

                {/* Profile Details */}
                <div className="flex flex-col gap-1.5 pt-1">
                  <h3 className="text-[#111827] text-[20px] sm:text-[22px] font-[900] tracking-tight leading-none">Alex Mercer</h3>
                  <p className="text-[#64748B] text-[14px] font-[500]">
                    Branch Administrative Officer | ID: <span className="font-[600]">#8821</span>
                  </p>
