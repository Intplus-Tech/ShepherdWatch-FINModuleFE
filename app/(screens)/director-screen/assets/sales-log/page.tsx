        ...
        <div className="mx-auto w-full px-4 sm:px-6 pt-6 pb-6 lg:px-8 lg:pt-8 lg:pb-8 max-w-[1200px] overflow-hidden">
          ...
          <div className="rounded-[12px] border border-[#EEF1F6] bg-white shadow-sm overflow-visible">
              ...
              <table className="w-full text-left text-[13px]">
                <thead>
                  <tr className="border-b border-[#EEF1F6]">
                    <th className="px-6 py-4 font-medium text-[#6B7280] w-[15%]">Date</th>
                    <th className="px-6 py-4 font-medium text-[#6B7280] w-[25%]">Branch</th>
                    <th className="px-6 py-4 font-medium text-[#6B7280] w-[25%]">Asset</th>
                    <th className="px-6 py-4 font-medium text-[#6B7280] w-[15%]">Sale Amount</th>
                    <th className="px-6 py-4 font-medium text-[#6B7280] w-[20%]">Buyer Info</th>
                  </tr>
                </thead>
            ...
            <div className="p-4 px-6 border-t border-[#EEF1F6]">
              <button className="flex items-center gap-2 text-[12px] font-[600] text-[#4B5563] border border-[#E5E7EB] bg-white rounded-[6px] px-3.5 py-2 hover:bg-gray-50 transition-colors shadow-sm w-max">
