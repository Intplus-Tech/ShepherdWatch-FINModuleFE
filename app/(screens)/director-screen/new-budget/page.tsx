      ...
      <div className="mx-auto w-full max-w-[1200px] rounded-[20px] bg-white shadow-[0_20px_60px_rgba(0,0,0,0.25)] overflow-hidden">
        <div className="flex flex-col lg:flex-row">
          ...
          <main className="flex-1 bg-[#F7F8FC]">
            <div className="flex items-center justify-between border-b border-[#EEF1F6] bg-white px-6 py-3">
              ...
              <div className="flex items-center gap-3 text-[9px] text-[#6B7280]">
                <div className="relative">
                  ...
                  <Input
                    className="h-7 w-[170px] rounded-[10px] border-[#E5E7EB] bg-[#F9FAFB] pl-8 text-[9px]"
                    placeholder="Search templates..."
                  />
                </div>
                <div className="h-7 w-7 rounded-full bg-[#EEF2FF]" />
                <div className="text-[9px] font-medium text-[#111827]">Rev. Anderson</div>
                <div className="h-7 w-7 rounded-full bg-[#111827]" />
              </div>
            </div>
            ...
            <div className="px-6 py-6">
              <div className="flex items-start justify-between gap-3">
                <div>
                  <h1 className="text-[16px] font-semibold text-[#111827]">Create New Budget Template</h1>
            ...
            <div className="border-t border-[#EEF1F6] bg-white px-6 py-3">
