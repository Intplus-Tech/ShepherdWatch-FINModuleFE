...
import { Search, Bell, ChevronLeft, Info, Package, ArrowRight } from "lucide-react"
      ...
      <div className="flex-1 flex flex-col w-full relative min-h-[100dvh]">
        ...
        <main className="flex-1 p-6 lg:p-8 min-w-0">
          ...
          <div className="flex items-center justify-between gap-4">
            ...
            {employee && (
              <button
                onClick={() => router.push(`/branchlead-pastor/hr/exit-clearance?employeeId=${employee._id}`)}
