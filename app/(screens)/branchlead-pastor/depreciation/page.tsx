          ...
          <aside className="w-65 border-r border-[#EEF1F6] bg-white flex-col justify-between hidden lg:flex shrink-0">
            <div className="p-6">
              <div className="flex items-center gap-2 pb-5">
                <Image src="/images/icon-shepherdwatch.svg" alt="ShepherdWatch logo" width={22} height={22} />
                <div>
              ...
              <div className="mt-6 flex items-center gap-2 pt-4">
                <div className="h-7 w-7 rounded-full overflow-hidden bg-[#E8EDFF]">
                  <img src="/images/Beared%20Guy02-min%201.jpg" alt="Profile avatar for Alex Morgan, Lead Pastor." className="h-full w-full object-cover" />
                </div>
