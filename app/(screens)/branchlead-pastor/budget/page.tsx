...
const calendarDays = [
  { label: "Mon 15", events: ["Sound Check"], tone: "bg-[#E9EEFF] text-[#3B5BDB]" },
  { label: "Tue 16", events: ["Backup Test"], tone: "bg-[#EEF2FF] text-[#3B5BDB]" },
  { label: "Wed 17", events: ["Safety Drill"], tone: "bg-[#E9EEFF] text-[#3B5BDB]" },
  { label: "Thu 18", events: ["Projector Swap"], tone: "bg-[#E9EEFF] text-[#3B5BDB]" },
  { label: "Fri 19", events: ["Lighting Fix"], tone: "bg-[#FEF3C7] text-[#B45309]" },
  { label: "Sat 20", events: ["Weekly Cleanup"], tone: "bg-[#ECFDF3] text-[#16A34A]" },
]
        ...
        <div className="flex flex-col lg:flex-row">
          ...
          <main className="flex-1 p-6 lg:p-7 bg-[#F7F8FC]">
            ...
            <div className="mt-3">
              ...
              <p className="text-[9px] text-[#9CA3AF]">Oversee asset upkeep and service schedules for the sanctuary.</p>
            </div>
                ...
                <div className="rounded-[12px] border border-[#EEF1F6] bg-white p-4">
                  ...
                  <div className="mt-3 space-y-2">
                    {urgentAlerts.map((item) => (
                      <div key={item.title} className={`rounded-[10px] border px-3 py-2 text-[9px] ${item.tone}`}>
                  ...
                  {calendarDays.map((day) => (
                    <div key={day.label} className="rounded-[8px] border border-[#EEF1F6] bg-[#F9FAFB] p-2">
                      ...
                      {day.events.map((event) => (
                        <div key={event} className={`mt-2 rounded-[6px] px-1.5 py-1 text-[7px] ${day.tone}`}>
                          {event}
                        </div>
                      ))}
                    </div>
