  ...
  return (
    <div className="flex min-h-screen w-full bg-[#FAFBFF] font-sans" style={{ fontFamily: '"Inter", sans-serif' }}>
      ...
      <div className="flex-1 flex flex-col min-h-screen overflow-x-hidden bg-[#FAFBFF]">
        ...
        {/* Top Header / Navbar */}
        <header className="flex h-[72px] shrink-0 items-center justify-between border-b border-[#EEF1F6] bg-white px-4 sm:px-6 lg:px-10 w-full relative z-10">
          ...
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between mb-8 gap-5">
            ...
            <div className="flex flex-wrap items-center gap-3 shrink-0">
              ...
              <Button
                ...
                disabled={exporting}
                className="h-[38px] rounded-[10px] bg-[#3B5BDB] px-4 text-[13px] font-bold text-white shadow hover:bg-blue-700 transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
              >
