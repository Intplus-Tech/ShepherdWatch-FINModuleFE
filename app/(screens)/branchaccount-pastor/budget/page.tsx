...
const budgetData = [
  {
    ...
    expanded: true,
    items: [
      { id: 1, name: "Salaries & Wages", actual: "₦45,000", proposed: "200,000", hasIcon: true, variance: "+8.1%", isPositive: true },
      { id: 2, name: "Utilities", actual: "₦45,000", proposed: "200,000", hasIcon: true, variance: "+11.1%", isPositive: true },
    ]
  },
  {
    ...
    expanded: true,
    items: [
      { id: 3, name: "Youth Ministry", actual: "₦45,000", proposed: "200,000", hasIcon: true, variance: "+5.6%", isPositive: true },
      { id: 4, name: "Outreach", actual: "₦45,000", proposed: "200,000", hasIcon: true, variance: "-16.6%", isPositive: false },
    ]
  },
  {
    ...
    expanded: true,
    items: [
      { id: 5, name: "Building Maintenance", actual: "₦45,000", proposed: "200,000", hasIcon: true, variance: "+11.1%", isPositive: true },
    ]
  }
]
      ...
      <div className="flex-1 flex flex-col min-h-screen relative w-full overflow-x-hidden">
        ...
        <header className="flex flex-col sm:flex-row justify-between items-start sm:items-center bg-transparent px-4 sm:px-6 xl:px-8 w-full gap-4 pt-3 pb-2 sm:pt-4 sm:pb-3">
          ...
          <div className="flex items-center flex-wrap gap-2 sm:gap-3 w-full sm:w-auto overflow-x-auto no-scrollbar pb-1 sm:pb-0">
            ...
            <button className="hidden sm:flex items-center justify-center h-[36px] px-4 rounded-[8px] bg-[#3B5BDB] text-[12px] text-white font-bold shadow-sm hover:bg-[#3451b2] transition-all shrink-0">
            ...
            <div className="flex-1 min-w-0 flex flex-col">
              ...
              <div className="flex flex-col md:flex-row md:items-end justify-between mb-5 sm:mb-6 gap-4 pt-2 border-t border-[#EEF1F6]/70">
                ...
                <div className="flex flex-row items-center w-full md:w-auto gap-3">
                  <button className="flex flex-1 justify-center md:flex-none whitespace-nowrap items-center h-[38px] md:h-[34px] px-3 sm:px-4 rounded-[6px] border border-[#E5E7EB] bg-white text-[12px] text-[#111827] font-bold shadow-sm hover:bg-gray-50 transition-all tracking-wide">
                    <Download className="mr-1.5 h-3.5 w-3.5" />
                    Export
                  </button>
                  <button className="flex flex-2 justify-center md:flex-none whitespace-nowrap items-center h-[38px] md:h-[34px] px-3 sm:px-4 rounded-[6px] bg-[#3B5BDB] text-[12px] text-white font-bold shadow-[0_4px_14px_rgba(59,91,219,0.25)] hover:bg-[#3451b2] transition-all tracking-wide">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5 mb-6 sm:mb-8">
                ...
                <div className="rounded-[16px] border border-[#EEF1F6] bg-white p-5 sm:p-6 shadow-[0_1px_3px_0_rgba(0,0,0,0.02)] flex flex-col justify-between h-[125px] sm:h-[135px]">
                  ...
                  <div className="mt-3 sm:mt-4">
                    <div className="text-[15px] xs:text-[16px] xl:text-[20px] font-bold text-[#111827] tracking-tight leading-tight mb-1 truncate">₦12,500,450,000.00</div>
                ...
                <div className="rounded-[16px] border border-[#EEF1F6] bg-white p-5 sm:p-6 shadow-[0_1px_3px_0_rgba(0,0,0,0.02)] flex flex-col justify-between h-[125px] sm:h-[135px]">
                  ...
                  <div className="mt-3 sm:mt-4">
                    <div className="text-[15px] xs:text-[16px] xl:text-[20px] font-bold text-[#111827] tracking-tight leading-tight mb-1 truncate">₦380,000,215.00</div>
                ...
                <div className="rounded-[16px] border border-[#EEF1F6] bg-white p-5 sm:p-6 shadow-[0_1px_3px_0_rgba(0,0,0,0.02)] flex flex-col justify-between h-[125px] sm:h-[135px]">
                  ...
                  <div className="mt-3 sm:mt-4">
                    <div className="text-[15px] xs:text-[16px] xl:text-[20px] font-bold text-[#111827] tracking-tight leading-tight mb-1 truncate">₦45,528,000.00</div>
                ...
                <div className="rounded-[16px] border border-[#EEF1F6] bg-white p-5 sm:p-6 shadow-[0_1px_3px_0_rgba(0,0,0,0.02)] flex flex-col justify-between h-[125px] sm:h-[135px]">
                  ...
                  <div className="mt-3 sm:mt-4">
                    <div className="text-[15px] xs:text-[16px] xl:text-[20px] font-bold text-[#111827] tracking-tight leading-tight mb-1 truncate">₦25,000,417.00</div>
              ...
              <div className="rounded-[16px] bg-white border border-[#EEF1F6] flex flex-col shadow-[0_1px_3px_0_rgba(0,0,0,0.02)] relative min-h-[460px] pb-[130px] sm:pb-[88px]">
                  ...
                  <table className="w-full min-w-[700px] md:min-w-[800px] text-left text-[13px] border-collapse">
                    ...
                    <tbody>
                      ...
                      <tr className="border-t-2 border-[#E5E7EB] bg-white">
                        ...
                        <td className="py-4 sm:py-5 font-bold text-[#6B7280] text-[13px] sm:text-[14px] text-center tracking-tight">₦420,000</td>
                        <td className="py-4 sm:py-5 font-bold text-[#111827] text-[14px] sm:text-[15px] text-center tracking-tight">₦450,000</td>
                        <td className="py-4 sm:py-5"></td>
                        <td className="py-4 sm:py-5 pr-4 sm:pr-6 lg:pr-8 font-bold text-[#10B981] text-right text-[12px] sm:text-[14px]">+7.1%</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
                ...
                <div className="absolute bottom-0 left-0 right-0 py-3 sm:py-4 px-4 sm:px-6 bg-[#F8FAFC] sm:bg-white border-t border-[#EEF1F6] flex flex-row items-center justify-between sm:justify-end gap-3 sm:gap-4 rounded-b-[16px]">
                  ...
                  <button className="h-[38px] sm:h-[40px] flex-1 sm:flex-none justify-center shrink-0 whitespace-nowrap px-4 sm:px-6 rounded-[8px] bg-[#3B5BDB] text-white text-[12px] sm:text-[13px] font-bold shadow-[0_4px_14px_rgba(59,91,219,0.35)] hover:bg-[#3451b2] transition-colors tracking-wide outline-none">
                    Submit Budget
                  </button>
                </div>
              </div>
